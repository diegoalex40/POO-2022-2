...
if __name__ == "__main__":
    ...
    driver2 = Driver(6, "Diego Flores", "Masculino", 99989999, 49, "Licencia113")
    print(vars(driver2))
    ...
    pago002 = PaymentCard(2, 6.9, "13-12-2022", 11123456, "Pacifico", [1712332132, "Noviembre 2023", "Diego Yanez", 559])
    print(vars(pago002))
    ...
    trip001 = Trip(1, User(1, "Diego Yanez", "Masculino", 99999999, 29), Driver(3, "Alexander Flores", "Masculino", 9999999, 29, "Licencia111"), Car("PBC-555555", "Chevrolet Corsa", "Gris", 2015, Driver(3, "Alexander Flores", "Masculino", 9999999, 29, "Licencia111")), Route([-0.21885831940848277, -78.51114957623152], [-0.2143, -78.5017], 5, 20), Payment(3, 7.3, "13-12-2022"))
    print(vars(trip001))
